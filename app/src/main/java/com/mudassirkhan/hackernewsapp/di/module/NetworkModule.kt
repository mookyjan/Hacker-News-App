...
class NetworkModule {
    ...
    @Singleton
    @VisibleForTesting
     fun provideHackerAPI(okHttpClient: OkHttpClient): HackerNewsApiService{
...
//            .add(MoshiConverters())
        ...
        return Retrofit.Builder()
            ...
            .client(okHttpClient)
            .build().create(HackerNewsApiService::class.java)
...
//        }
    ...
    private fun getUrl(isApi: Boolean): String {
        return if (isApi) BuildConfig.API_URL else BuildConfig.API_HN_URL
    }
